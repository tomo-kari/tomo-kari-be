...
func (uc *TranslationUseCase) History(ctx context.Context) ([]entity.Translation, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("TranslationUseCase - History - s.userRepo.GetHistory: %w", err)
	}
...
func (uc *TranslationUseCase) Translate(ctx context.Context, t entity.Translation) (entity.Translation, error) {
	...
	if err != nil {
		return entity.Translation{}, fmt.Errorf("TranslationUseCase - Translate - s.userRepo.Store: %w", err)
	}
